...
export default function Successful({ imageURL }) {
  ...
  return (
    <>
      <div className='absolute w-[400.36px] h-[454.96px] top-[308.42px] bottom-[316-62px] left-[519.82px] bg-[#FFFFFF] shadow-3xl rounded-[12px]'>
        ...
        <div className={`absolute w-[338px] h-[224.4px] top-[137.87px] left-[31.18px] rounded-[12px] bg-[url(${imageURL})]`}></div>
        ...
        <div className='absolute w-[338px] h-[34px] bottom-[33.35px] left-[31.18px] border-box bg-[#F6F8FB] border-[1px] border-solid border-[#E0E0E0] rounded-[8px]'>
            ...
            <p className='absolute w-[240px] h-[12px] top-[11px] left-[7.12px] font-pop non-italic font-medium text-[8px] leading-[12px] tracking-[-0.035em] text-center text-[#4F4F4F]'>{imageURL}</p>
